...
<head>
    ...
    <title>VMS - Admin Panel | Manage Charity</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_charity.php"><i class="sidebar-item-icon fa fa-hand-rock-o"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Manage Charity</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Charity List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary"><?php echo '[CF-00'.$result['foundation_id'].']'; ?></td>
                                    <td style="width: 12%;"><img src="<?php echo '../../../Volunteer_Panel/html/dist/'.$result['foundation_img'] ?>" width="100" height="80" alt="foundation_img"></td>
                                    <td><?php echo $result['foundation_name']; ?></td>
                                    <td><?php echo $result['email_address']; ?></td>
                                    <td><?php echo $result['contact_number']; ?></td>
                                    <td><?php echo $result['foundation_address']; ?></td>
                                    <td><?php echo date("F j, Y", strtotime($result['foundation_added_on'])) ?></td>
                                    <td>
                                        <?php
                                            $foundation_verify_status = $result['foundation_verify_status'];

                                            if($foundation_verify_status == 1)
                                            {
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                            ?>
                                                <a href="charity_verify.php?foundation_id=<?php echo $result['foundation_id']; ?>" onclick="return confirm('Sure to active charity foundation?')" class="btn btn-success btn-sm" style="border-radius: 15px;"> Active Org.</a>
                                            <?php
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="delete_data.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
