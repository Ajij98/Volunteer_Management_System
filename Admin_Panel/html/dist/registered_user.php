...
<head>
    ...
    <title>VMS - Admin Panel | Registered User</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="registered_user.php"><i class="sidebar-item-icon fa fa-users"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Registered User</h1>
                <ol class="breadcrumb">
                    ...
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary"><?php echo '[UI-00'.$result['user_id'].']'; ?></td>
                                    <td><?php echo $result['name']; ?></td>
                                    <td><?php echo $result['email']; ?></td>
                                    <td><?php echo $result['phone']; ?></td>
                                    <td><?php echo $result['address']; ?></td>
                                    <td class="text-primary"><?php echo $result['user_type']; ?></td>
                                    <td><?php echo date("F j, Y", strtotime($result['entry_time'])) ?></td>
                                    <td>
                                        <a href="delete_data.php?user_id=<?php echo $result['user_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
