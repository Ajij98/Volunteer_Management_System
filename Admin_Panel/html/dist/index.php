...
<head>
    ...
    <title>VMS - Admin Panel | Home</title>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-secondary color-white widget-stat">
                            <div class="ibox-body">
                                ...
                                <div class="m-b-5">REGISTERED USERS</div><i class="fa fa-users widget-stat-icon"></i>
                                <div><small><a href="registered_user.php" style="text-decoration: underline;" class="text-light">View More</a></small></div>
                            </div>
                        </div>
                    </div>
                </div>
