...
<head>
    ...
    <title>VMS - Volunteer Panel | Manage Charity</title>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Added On</th>
                                    <th>Foundation Verify Status</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 12%;"><img src="<?php echo $result['foundation_img'] ?>" width="100" height="80" alt="foundation_img"></td>
                                    <td><?php echo $result['foundation_name']; ?></td>
                                    <td><?php echo $result['email_address']; ?></td>
                                    <td><?php echo $result['contact_number']; ?></td>
                                    <td><textarea class="form-control" rows="3"><?php echo $result['foundation_address']; ?></textarea></td>
                                    ...
                                    <td>
                                        <a href="update_charity_details.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
