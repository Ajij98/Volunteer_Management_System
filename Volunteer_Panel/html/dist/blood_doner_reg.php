<?php
 ...
 <?php
   ...
   {    
         ...
         $sql = "INSERT INTO tb_blood_doner(doner_code,doner_name,blood_group,doner_address,contact_number,doner_registered_on,doner_img,doner_username,entry_time)values('$doner_code','$doner_name','$blood_group','$doner_address','$contact_number','$doner_registered_on','$dst_db','$doner_username','$current_datetime')";
...
<head>
    ...
    <title>VMS - Volunteer Panel | Blood Doner Registration</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="blood_doner_reg.php"><i class="sidebar-item-icon fa fa-tint"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Blood Doner Registration</h1>
                <ol class="breadcrumb">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="doner_name" placeholder="Blood doner name" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Address</label>
                                            <textarea class="form-control" rows="3" name="doner_address" placeholder="Blooad doner address" required></textarea>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Contact Number</label>
                                            <input class="form-control" type="number" name="contact_number" placeholder="Blood doner contact number" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Registered On</label>
                                            <input class="form-control" type="date" name="doner_registered_on" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Doner Image</label>
                                            <input class="form-control" type="file" name="doner_img" required>
                                        </div>
                                    </div>
                                    <input type="submit" name="submit" class="btn btn-primary" value="Register Doner">
                                </form>
