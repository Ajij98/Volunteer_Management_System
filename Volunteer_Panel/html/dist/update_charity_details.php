  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         if($foundation_img != "")
         {
           ...
           $sql = "UPDATE tb_charity_foundation SET foundation_name='$foundation_name',contact_number='$contact_number',email_address='$email_address',external_link='$external_link',about_foundation='$about_foundation',foundation_address='$foundation_address',foundation_added_on='$foundation_added_on',foundation_img='$dst_db',way_of_donation='$way_of_donation' WHERE foundation_id = $foundation_id";

           $update_row = $db->update($sql);
         }

         $sql = "UPDATE tb_charity_foundation SET foundation_name='$foundation_name',contact_number='$contact_number',email_address='$email_address',external_link='$external_link',about_foundation='$about_foundation',foundation_address='$foundation_address',foundation_added_on='$foundation_added_on',way_of_donation='$way_of_donation' WHERE foundation_id = $foundation_id";
...
<head>
    ...
    <title>VMS - Volunteer Panel | Update Charity Details</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_charity.php"><i class="sidebar-item-icon fa fa-list-ul"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Update Charity Details</h1>
                <ol class="breadcrumb">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="foundation_name" placeholder="Charity foundation name" value="<?php echo $foundation_name; ?>" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="email" name="email_address" placeholder="Email address" value="<?php echo $email_address; ?>" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>External Link</label>
                                            <input class="form-control" type="text" name="external_link" placeholder="External link if any" value="<?php echo $external_link; ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>About Founation</label>
                                            <textarea class="form-control" rows="4" name="about_foundation" placeholder="Type something about foundation" required><?php echo $about_foundation; ?></textarea>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Foundation Address</label>
                                            <textarea class="form-control" rows="4" name="foundation_address" placeholder="Type foundation address" required><?php echo $foundation_address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Foundation Added On</label>
                                            <input class="form-control" type="date" name="foundation_added_on" value="<?php echo $foundation_added_on; ?>" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <img src="<?php echo $foundation_img; ?>" height="120" style="border: 2px solid black;"><br>
                                            <label>Foundation Image</label>
                                            <input class="form-control" type="file" name="foundation_img">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            <label>Way of Donation <span class="text-danger">**(Describe briefly)</span></label>
                                            <textarea class="form-control" name="way_of_donation" id="way_of_donation" required><?php echo $way_of_donation; ?></textarea>
                                        </div>
                                    </div>
