...
<head>
    ...
    <title>VMS - Volunteer Panel | Blood Doner List</title>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;"><img src="<?php echo $result['doner_img'] ?>" width="100" height="80" alt="blood_doner_img"></td>
                                    ...
                                    <td>
                                        <a href="update_blood_doner.php?doner_id=<?php echo $result['doner_id']; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?doner_id=<?php echo $result['doner_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
