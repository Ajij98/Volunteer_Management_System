<?php
 ...
 <?php
   ...
   {    
         $profile_code         = rand(100000, 999999);
         $name                 = $_POST['name'];
         ...
         $sql = "INSERT INTO tb_volunteer_profile(profile_code,name,profession,address,contact_number,email,facebook_id,whatsapp_number,profile_img,profile_objective,volunteer_experience,education,relevant_skills,organization,profile_added_on,profile_created_by,entry_time)values('$profile_code','$name','$profession','$address','$contact_number','$email','$facebook_id','$whatsapp_number','$dst_db','$profile_objective','$volunteer_experience','$education','$relevant_skills','$organization','$profile_added_on','$profile_created_by','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Profile details added successfully.");
...
<head>
    ...
    <title>VMS - Volunteer Panel | Add Volunteer Profile</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="add_volunteer_profile.php"><i class="sidebar-item-icon fa fa-plus"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Add Volunteer Profile</h1>
                <ol class="breadcrumb">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="profession" placeholder="Your profession" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="facebook_id" placeholder="Facebook id link" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Whats App Number</label>
                                            <input class="form-control" type="number" name="whatsapp_number" placeholder="Whats app number" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <textarea class="form-control" name="profile_objective" id="profile_objective" required></textarea>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Volunteer Experience</label>
                                            <textarea class="form-control" name="volunteer_experience" id="volunteer_experience" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <textarea class="form-control" name="relevant_skills" id="relevant_skills" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Organization(if any)</label>
                                            <input class="form-control" type="text" name="organization" placeholder="work with any organization">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Profile Added On</label>
                                            <input class="form-control" type="date" name="profile_added_on" required>
                                        </div>
                                    </div>
                                    <input type="submit" name="submit" class="btn btn-primary" value="Add Profile">
                                </form>
