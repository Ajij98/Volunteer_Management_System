...
<head>
    ...
    <title>VMS - Volunteer Panel | Manage Profile</title>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;"><img src="<?php echo $result['profile_img'] ?>" width="100" height="80" alt="volunteer_img"></td>
                                    ...
                                    <td>
                                        <a href="update_volunteer_profile.php?profile_id=<?php echo $result['profile_id']; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?profile_id=<?php echo $result['profile_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
